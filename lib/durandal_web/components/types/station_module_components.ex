defmodule DurandalWeb.StationModuleTypeComponents do
  @moduledoc false
  use DurandalWeb, :component
  import DurandalWeb.{NavComponents}

  @doc """
  <DurandalWeb.StationModuleTypeComponents.filter_bar active="active" />
    ...
    <div class="row section-menu">
      <div class="col">
        <.section_menu_button_url
          ...
          url={~p"/admin/station_module_types"}
        >
          List
        </.section_menu_button_url>
        ...
        <.section_menu_button_url
          ...
          active={@selected == "new"}
          url={~p"/admin/station_module_types/new"}
        >
          New
        </.section_menu_button_url>
