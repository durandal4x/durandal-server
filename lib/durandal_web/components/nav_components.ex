defmodule DurandalWeb.NavComponents do
  ...
  @doc """
  <DurandalWeb.NavComponents.top_nav_item active={active} route={route} icon={icon} />
  """
  ...
  @doc """
  <DurandalWeb.NavComponents.top_navbar current_user={@current_user} active={"string"} />
  """
