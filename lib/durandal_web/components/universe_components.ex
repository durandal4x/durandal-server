defmodule DurandalWeb.UniverseComponents do
  @moduledoc false
    ...
    <div class="row section-menu">
      <div class="col">
        ...
        <.section_menu_button_url
          ...
          active={@selected == "new"}
          url={~p"/admin/games/universes/new"}
        >
          New
        </.section_menu_button_url>
  ...
  @doc """
  <DurandalWeb.UserComponents.account_dropdown current_user={@current_user} />
  """
  attr :current_user, :map, required: true
