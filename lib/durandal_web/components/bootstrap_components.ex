defmodule DurandalWeb.BootstrapComponents do
  @moduledoc false
  ...
  @doc """
  <DurandalWeb.BootstrapComponents.dropdown items={@items} />
  """
  ...
  @doc """
  <DurandalWeb.BootstrapComponents.dropdown unit={@unit} limit={@limit} display_mode={@display_mode} />
  ...
  @doc """
  <DurandalWeb.BootstrapComponents.card>
    CONTENT
  </DurandalWeb.BootstrapComponents.card>
  """
  slot :inner_block, required: true
  ...
  <DurandalWeb.BootstrapComponents.pill>
    CONTENT
  </DurandalWeb.BootstrapComponents.pill>
  """
  slot :inner_block, required: true
