defmodule Durandal.Types do
  ...
  # ColonyModuleTypes
  alias Durandal.Types.{ColonyModuleType, ColonyModuleTypeLib, ColonyModuleTypeQueries}

  @doc false
  @spec colony_module_types_query(Durandal.query_args()) :: Ecto.Query.t()
  defdelegate colony_module_types_query(args), to: ColonyModuleTypeQueries

  @doc section: :colony_module_type
  @spec list_colony_module_types(Durandal.query_args()) :: [ColonyModuleType.t()]
  defdelegate list_colony_module_types(args), to: ColonyModuleTypeLib

  @doc section: :colony_module_type
  @spec get_colony_module_types!(ColonyModuleType.id(), Durandal.query_args()) ::
          ColonyModuleType.t()
  defdelegate get_colony_module_types!(colony_module_types_id, query_args \\ []),
    to: ColonyModuleTypeLib
  ...
  defdelegate create_colony_module_types(attrs), to: ColonyModuleTypeLib

  @doc section: :colony_module_type
  @spec update_colony_module_types(ColonyModuleType, map) ::
          {:ok, ColonyModuleType.t()} | {:error, Ecto.Changeset.t()}
  defdelegate update_colony_module_types(colony_module_types, attrs), to: ColonyModuleTypeLib

  @doc section: :colony_module_type
  @spec delete_colony_module_types(ColonyModuleType.t()) ::
          {:ok, ColonyModuleType.t()} | {:error, Ecto.Changeset.t()}
  defdelegate delete_colony_module_types(colony_module_types), to: ColonyModuleTypeLib

  @doc section: :colony_module_type
  @spec change_colony_module_types(ColonyModuleType.t(), map) :: Ecto.Changeset.t()
  defdelegate change_colony_module_types(colony_module_types, attrs \\ %{}),
    to: ColonyModuleTypeLib
