defmodule Durandal.Space.StationTransfer do
  @moduledoc """
  # StationTransfer
  Description here
  ...
  * `:completed_tick` - field description
  ...
  schema "space_station_transfers" do
  ...
  @required_fields ~w(universe_id station_id distance progress status started_tick origin)a
