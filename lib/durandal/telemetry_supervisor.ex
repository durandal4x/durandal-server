defmodule Durandal.TelemetrySupervisor do
  ...
  defp repo_metrics() do
    [
      ...
      summary("durandal.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("durandal.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("durandal.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("durandal.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
