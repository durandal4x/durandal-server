defmodule Durandal.Blog do
  @moduledoc """
  Main point of usage for the blog system
  """
  ...
  alias Durandal.Blog.{Tag, TagLib}
  ...
  alias Durandal.Blog.{Post, PostLib}
  ...
  alias Durandal.Blog.{PostTag, PostTagLib}
  ...
  alias Durandal.Blog.{UserPreference, UserPreferenceLib}
  ...
  alias Durandal.Blog.{PollResponse, PollResponseLib}
