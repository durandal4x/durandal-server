defmodule Durandal.Account.UserTokenLib do
  @moduledoc """
  Library of UserToken related functions.
  """
  alias Durandal.Repo
  alias Durandal.Account.{UserToken, UserTokenQueries}
  ...
  def delete_user_token(%UserToken{} = user_token) do
    Durandal.invalidate_cache(:user_token_identifier_cache, user_token.identifier_code)
  ...
  @spec delete_user_tokens(Durandal.user_id()) :: :ok
