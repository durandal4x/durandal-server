defmodule Durandal.Game.WatcherServer do
  ...
  @impl true
  def handle_info(%{topic: "Durandal.Global.Universe", event: :created_universe} = msg, %State{} = state) do
  ...
  def handle_info(%{topic: "Durandal.Global.Universe", event: :deleted_universe} = msg, %State{} = state) do
  ...
  def handle_info(%{topic: "Durandal.Global.Universe", event: :updated_universe} = msg, %State{} = state) do
