defmodule Durandal.SystemQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Space.SystemQueries

  describe "queries" do
    @empty_query SystemQueries.system_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        SystemQueries.system_query(where: [not_a_key: 1])
      end)
