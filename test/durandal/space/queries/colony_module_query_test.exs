defmodule Durandal.ColonyModuleQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Space.ColonyModuleQueries

  describe "queries" do
    @empty_query ColonyModuleQueries.colony_module_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        ColonyModuleQueries.colony_module_query(where: [not_a_key: 1])
      end)
      ...
      all_values =
        ColonyModuleQueries.colony_module_query(
          where: [
            ...
            colony_id: "fc7cd2d5-004a-4799-8cec-0d198016e292",
            type_id: [
              "92a26447-572e-4e3e-893c-42008287a9aa",
              "5bed6cfe-0ffd-40bf-ad49-4e82ca65c9be"
            ],
