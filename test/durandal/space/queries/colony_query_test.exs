defmodule Durandal.ColonyQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Space.ColonyQueries

  describe "queries" do
    @empty_query ColonyQueries.colony_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        ColonyQueries.colony_query(where: [not_a_key: 1])
      end)
