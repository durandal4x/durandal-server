defmodule Durandal.StationModuleTypeQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Types.StationModuleTypeQueries

  describe "queries" do
    @empty_query StationModuleTypeQueries.station_module_type_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        StationModuleTypeQueries.station_module_type_query(where: [not_a_key: 1])
      end)
