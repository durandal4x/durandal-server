defmodule Durandal.ColonyModuleTypeQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Types.ColonyModuleTypeQueries

  describe "queries" do
    @empty_query ColonyModuleTypeQueries.colony_module_types_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        ColonyModuleTypeQueries.colony_module_types_query(where: [not_a_key: 1])
      end)
