defmodule Durandal.ShipTypeQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Types.ShipTypeQueries

  describe "queries" do
    @empty_query ShipTypeQueries.ship_type_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        ShipTypeQueries.ship_type_query(where: [not_a_key: 1])
      end)
