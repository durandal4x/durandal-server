defmodule Durandal.CompositeStationModuleInstanceQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Resources.CompositeStationModuleInstanceQueries

  describe "queries" do
    @empty_query CompositeStationModuleInstanceQueries.composite_station_module_instance_query([])
