defmodule Durandal.SimpleShipInstanceQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Resources.SimpleShipInstanceQueries

  describe "queries" do
    @empty_query SimpleShipInstanceQueries.simple_ship_instance_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        SimpleShipInstanceQueries.simple_ship_instance_query(where: [not_a_key: 1])
      end)
