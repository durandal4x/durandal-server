defmodule Durandal.CompositeShipInstanceQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Resources.CompositeShipInstanceQueries

  describe "queries" do
    @empty_query CompositeShipInstanceQueries.composite_ship_instance_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        CompositeShipInstanceQueries.composite_ship_instance_query(where: [not_a_key: 1])
      end)
