defmodule Durandal.CompositeTypeQueriesTest do
  @moduledoc false
  use Durandal.DataCase, async: true

  alias Durandal.Resources.CompositeTypeQueries

  describe "queries" do
    @empty_query CompositeTypeQueries.composite_type_query([])
    ...
    test "clauses" do
      ...
      assert_raise(FunctionClauseError, fn ->
        CompositeTypeQueries.composite_type_query(where: [not_a_key: 1])
      end)
